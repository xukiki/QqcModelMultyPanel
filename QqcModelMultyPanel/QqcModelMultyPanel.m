...
@implementation QqcModelMultyPanel
...
- (void)showModelAppendView:(UIView*)view2show animationType:(QqcModelAnimationType)animationType bgAlpha:(CGFloat)alpha isOnCenter:(BOOL)bIsOnCenter
{
    ...
    self.view2show = view2show;
    self.bgAlpha = alpha;
    self.bIsOnCenter = bIsOnCenter;
    
    [self addBgImageView];
    [self addSubview:view2show];
    [self adjustPropertyOfViewByAnimationType];
...
- (void)doModel
{
    ...
    if (self.view2show.nextResponder && [self.view2show.nextResponder isKindOfClass:[UIViewController class]]) {
        ...
        [self.myWindow.rootViewController addChildViewController:(UIViewController *)self.view2show.nextResponder];
    }
